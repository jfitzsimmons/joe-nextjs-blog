...
const draw = ctx => {
    ...
    function backgroundGradients(layers) {
        for (let i=layers; i--;) {
            ...
            grd.addColorStop(0, `rgba(${rndmRng(255,229)}, ${rndmRng(215,185)}, ${rndmRng(218,192)}, ${rndmRng(.5,.1)})`);
            grd.addColorStop(1, `rgba(${rndmRng(255,229)}, ${rndmRng(215,185)}, ${rndmRng(218,192)}, 0)`);
    ...
    function curvedLine() {
        ...
        for(var i=startX; i<=w+100; i+=lineDash+lineSpace){
